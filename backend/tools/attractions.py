...
def search_attractions(destination):
    ...
    res_act=tavily_client.search(query1,max_results=10)
    res_restaurant=tavily_client.search(query2,max_results=10)
    res_activities=tavily_client.search(query3,max_results=10)
