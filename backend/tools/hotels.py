...
def search_hotels(destination,check_in,check_out,rating,currency="INR",sort_by=3,adults=1,children=0,max_price=None):
    """ 
...
if __name__=="__main__":
    ...
    hotels=search_hotels(destination,check_in,check_out,rating,currency,sort_by,adults,children,max_price)
    print(hotels)
